<!--页脚-->
<footer class="page_footer text-center">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 col-md-12">
                <span> <i class="glyphicon glyphicon-info-sign" aria-hidden="true"></i><a href="<?php echo base_url("index.php/user/user_questions"); ?>"> 关于我们</a></span> |
