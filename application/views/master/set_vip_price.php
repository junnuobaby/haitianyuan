                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered ">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" id="monthly_vip" data-type="text" data-pk="1" class="theme-color"><?php echo $month_vip;?></a>
                                </td>
                            </tr>
                            <tr>
                                <td>半年（180天）</td>
                                ...
                                <td>
                                    <a href="#" id="half_year_vip" data-type="text" data-pk="2"  class="theme-color"><?php echo $month_vip;?></a>
                                </td>
                            </tr>
                            <tr>
                                <td>一年（360天）</td>
                                ...
                                <td >
                                    <a href="#" id="year_vip" data-type="text" data-pk="3" class="theme-color"><?php echo $month_vip;?></a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
...
<script>
    $(function(){
        $('#monthly_vip').editable({
            url:  '<?php echo base_url("index.php/master/change_price"); ?>',
            title: '修改月会员价格',
            name: 'month'
        });
