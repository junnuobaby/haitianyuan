        ...
        <div class="row">
            <div class="col-md-4">
                <div class="index-vip-box">
                    <img src="<?php echo base_url('assets/images/other/v1.png'); ?>"/>
                    <h3>丰厚奖金</h3>
            ...
            <div class="col-md-4">
                <div class="index-vip-box">
                    <img src="<?php echo base_url('assets/images/other/v2.png'); ?>"/>
                    <h3>无限提问</h3>
            ...
            <div class="col-md-4">
                <div class="index-vip-box">
                    <img src="<?php echo base_url('assets/images/other/v3.png'); ?>"/>
                    <h3>理财特助</h3>
