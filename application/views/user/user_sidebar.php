...
<div class="profile-sidebar">
    <div class="profile-userpic">
        <img class="img-circle img-responsive" src="<?php echo base_url('/assets/images/touxiang/6.jpg'); ?>" alt="我的头像">
        ...
        <ul class="list-group ">
            <li class="list-group-item ">
                ...
                <div class="list-group">
                    <a href="<?php echo base_url('index.php/user/user_questions');?>" class="list-group-item">我的提问</a>
                </div>
            </li>
            <li class="list-group-item ">
                <h4><i class="glyphicon glyphicon-usd"></i> 会员</h4>
                <div class="list-group">
                    <a href="<?php echo base_url('index.php/user/user_vips');?>" class="list-group-item">我的理财师</a>
                </div>
            </li>
            <li class="list-group-item ">
            ...
            <li class="list-group-item ">
                ...
                <div class="list-group">
                    ...
                    <a href="<?php echo base_url('index.php/user/user_profile'); ?>" class="list-group-item">修改个人资料</a>
                </div>
            </li>
        </ul>
    </div>
